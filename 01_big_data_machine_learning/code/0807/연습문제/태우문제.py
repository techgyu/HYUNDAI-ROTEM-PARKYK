...
LOG_LI_SELECT = True  # li 선택 로그 출력 여부
LOG_PRICE_SPAN = False  # 가격 영역 로그 출력 여부
LOG_SIZE = False  # 사이즈 로그 출력 여부
LOG_PRICE_TEXT = False  # 가격 텍스트 로그 출력 여부
LOG_PRICE = False  # 가격 로그 출력 여부
...
for li in soup.select('div.menu-list ul li'):
    ...
    if LOG_LI_SELECT:
        ...
        print("li.select_result: \n", result)
        print("result_length: ", len(result))  # (디버깅용) 가격 영역의 span 태그 개수 확인
